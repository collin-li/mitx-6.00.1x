...
from ps4_0 import *
from ps4_1 import getWordScore
from ps4_2 import updateHand
from ps4_3 import isValidWord
from ps4_4 import calculateHandlen
...
def playGame(wordList):
    ...
    while gameMode != 'e':
        ...
        if gameMode in 'nr':
            ...
            if 'hand' in locals(): # Check whether hand has been previously set
            
                # Ask user to choose human or computer player
                player = input('Enter u to have yourself play, c to have the computer play: ').lower()
                while not player in list('uc'): # Enforce valid input
                    print('Invalid command.')
                    player = input('Enter u to have yourself play, c to have the computer play: ').lower()
                
                if player == 'u': # Initialize human controlled game
                    playHand(hand, wordList, HAND_SIZE)
                elif player == 'c': # Initialize computer controlled game
                    compPlayHand(hand, wordList, HAND_SIZE)
            
            else: # If hand has not been previously set
                print('You have not played a hand yet. Please play a new hand first!')
                
# END SOLUTION

# Helper functions developed by the MITx 6.00.1x course
